...
class Multilink(object):
    ...
    gamma : float
        ...
        Also known as anisotropy ratio, a dimensionless group
    spring_const : float
        Dimensionless spring constant.
    sp : float
        Sperm number, a dimensionless group
    """
    ...
    def kinematic_constraint_mat(self, theta):
        """
        Kinematic constraint coefficients.
        ...
        Cxtheta : 2d numpy array N-1 * N-1
            coefficients for theta_dot
        Cyy : 2d numpy array N-1 * N-1
            coefficients for y_dot
        Cytheta : 2d numpy array N-1 * N-1
            coefficients for theta_dot
    ...
    def viscous_force_x_coef(self, theta):
        ...
        if n == self.N or n == 1 :
            ...
            raise ValueError('theta should have either {} columns or 1 column'.format(self.N))